        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="p-4 bg-surface-dark rounded-full border border-accent/10 group-hover:border-accent group-hover:glow transition-all duration-300">
                  <FaEnvelope className="w-8 h-8" style={{ color: '#EA4335' }} />
                </div>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="p-4 bg-surface-dark rounded-full border border-accent/10 group-hover:border-accent group-hover:glow transition-all duration-300">
                  <FaGithub className="w-8 h-8" style={{ color: '#ffffff' }} /> {/* Changed color to white */}
                </div>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="p-4 bg-surface-dark rounded-full border border-accent/10 group-hover:border-accent group-hover:glow transition-all duration-300">
                  <FaLinkedin className="w-8 h-8" style={{ color: '#0A66C2' }} />
                </div>
